...
minigame.name = "Hit the Balls!";
minigame.description = "Hit the balls!"
minigame.duration = 20.0;
minigame.end_delay = 1.0;
minigame.location = "boxarena";
minigame.music = "knockout";
minigame.min_players = 2;

local ball_model = "models/player/items/scout/soccer_ball.mdl";
local beam_model = "sprites/laser.vmt";
local end_sound = "player/taunt_bell.wav";
