...
minigame.name = "Pickup Plate";
minigame.duration = 9.0;
...
chosen_item <- items[RandomIndex(items)];

minigame.description = format("Pickup the %s!", chosen_item[2]);
minigame.custom_overlay = chosen_item[1];
