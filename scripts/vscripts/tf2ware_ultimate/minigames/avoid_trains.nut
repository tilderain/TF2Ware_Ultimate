...
minigame.name = "Avoid the Trains";
minigame.description = "Dodge the trains!"
minigame.duration = 6.0;
minigame.music = "train";
minigame.start_pass = true;
minigame.fail_on_death = true;

local start_sound = "tf2ware_ultimate/train_rain.wav";
local train_model = "models/props_vehicles/train_enginecar.mdl";
...
function OnStart()
{
	...
	{
		local data = minigame_players.remove(RandomIndex(minigame_players));
