// 52 hits per player at 0 players, ~42 hits per player at 12 players
merasmus_health_per_player <- RemapValClamped(Ware_Players.len().tofloat(), 0.0, 12.0, 3333.0, 2750.0)
