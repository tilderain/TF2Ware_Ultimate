...
local heavy_model = "models/player/geavy.mdl";
local vo_love_sound = "TF2Ware_Ultimate.GeavyLove";
local vo_disgust_sound = "TF2Ware_Ultimate.ScoutDisgust";
local vo_kiss_sound = "Heavy.Generic01";
