...
minigame.duration = 79.5;
minigame.end_delay = 0.5;
minigame.music = "ghostbusters";
...
local ghost_model = "models/props_halloween/ghost.mdl";
local vo_ghost_sound = "TF2Ware_Ultimate.GhostLaugh";
